<div class="post">
    ...
    <div class="post__content">
        <div class="post__slider">
            <div class="post__image-container">
                <?php if (!empty($post['images'])): ?>
                    <?php foreach ($post['images'] as $index => $image): ?>
                        <img class="post__image <?= $index === 0 ? 'active' : '' ?>" 
            ...
            <?php if (count($post['images'] ?? []) > 1): ?>
                <img class="slider-icon slider-icon_left" src="./icons/left-slider.svg" alt="Предыдущее">
                <img class="slider-icon slider-icon_right" src="./icons/right-slider.svg" alt="Следующее">
            <?php endif; ?>
        </div>
